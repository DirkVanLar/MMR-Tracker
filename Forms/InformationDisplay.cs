...
namespace MMR_Tracker_V2
{
    public partial class DebugScreen : Form
    {
        ...
        public void PrintInfo()
        {
            ...
            Lines.Add("You can also select a settings file (.MMRTSET) generated by the Tracker.");
            Lines.Add("This will use the logic the tracker had when you save the setting originally.");
            Lines.Add("It will automatically apply the setting in the file after logic creation.");
            Lines.Add(Utility.CreateDivider(listBox1));
